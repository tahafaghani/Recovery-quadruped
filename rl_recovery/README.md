...
### Usage ###
1. Train:  
  ```python legged_gym/scripts/python train.py --sim_device=cuda --rl_device=cuda --pipeline=cpu --num_envs=4500 --max_iterations=6000 --task=iust```
...
```python legged_gym/scripts/play.py --sim_device=cuda --rl_device=cuda --pipeline=cpu --num_envs=200 --task=iust```
